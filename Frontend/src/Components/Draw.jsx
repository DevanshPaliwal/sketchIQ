...
function Draw() {
  ...
  const saveToHistory = () => {
    ...
    setHistory((prevHistory) => [...prevHistory.slice(0, historyStep + 1), imageData]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex gap-6">
          ...
          >
            ...
            <button onClick={undo} className="w-full bg-gray-500 text-white p-2 rounded-lg">Undo</button>
            <button onClick={redo} className="w-full bg-gray-500 text-white p-2 rounded-lg">Redo</button>
            <button onClick={saveDrawing} className="w-full bg-green-500 text-white p-2 rounded-lg">Save</button>
          </div>
