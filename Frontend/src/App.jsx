...
// Simulated art-related icons (using basic SVG)
const PaletteIcon = () => (
  ...
  const navigate = useNavigate();
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 flex flex-col">
            ...
            <header className="bg-white shadow-md py-6">
                <div className="container mx-auto px-4 flex justify-between items-center">
                    ...
                    <nav className="space-x-6">
                        ...
                        <button className="hover:text-blue-600 transition">Gallery</button>
                        <button className="hover:text-blue-600 transition">Create</button>
                        <button className="bg-blue-600 text-white px-4 py-2 rounded-full hover:bg-blue-700 transition" onClick={goToLogin} >
                            Login
                        </button>
                    </nav>
                </div>
            ...
            {/* Hero Section */}
            <main className="flex-grow container mx-auto px-4 py-16 grid md:grid-cols-2 items-center gap-12">
                ...
                <div className="relative">
                    ...
                    <div className="relative z-10 bg-white p-6 rounded-xl shadow-2xl">
                        <div className="h-64 bg-gradient-to-br from-blue-200 to-purple-200 rounded-lg"></div>
                    </div>
                </div>
            </main>
